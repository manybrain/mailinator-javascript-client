import {GetLatestInboxMessagesRequest, Inbox} from '../../src/message';
...
// Tests are skipped. There was never a GetLatestInboxMessages endpoint
describe.skip('GetLatestInboxMessagesRequest Tests', function () {
